...
from sqlalchemy import BigInteger, DateTime, Column, Enum, ForeignKey, Integer, Numeric, String, func, Boolean
...
class User(Base):
    ...
    # ПОЛЕ ДЛЯ РАССЫЛКИ: отмечаем тех, кто заблокировал бота, чтобы экономить ресурсы
